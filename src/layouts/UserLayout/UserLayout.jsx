      ...
      <Layout className="user-layout" style={styles.container}>
        <div className="header">
          <a href="#" className="meta">
            <img className="logo" src="https://img.alicdn.com/tfs/TB13UQpnYGYBuNjy0FoXXciBFXa-242-134.png" alt="logo" />
            <span className="title">Trantor</span>
          </a>
          <p className="desc">the next generation</p>
        </div>
