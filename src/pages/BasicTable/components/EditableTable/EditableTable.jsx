...
export default class EditableTable extends Component {
  ...
  renderEditor = (valueKey, value, index, record) => {
    return <CellEditor valueKey={valueKey} index={index} value={record[valueKey]} onChange={this.changeDataSource} />
  }
      ...
      <div className="editable-table">
        <IceContainer>
          <Table dataSource={this.state.dataSource} hasBorder={false}>
            ...
            <Table.Column width={280} title="待办事项" cell={this.renderEditor.bind(this, 'todo')} />
            <Table.Column width={240} title="备注" cell={this.renderEditor.bind(this, 'memo')} />
            <Table.Column width={180} title="有效时间" cell={this.renderEditor.bind(this, 'validity')} />
